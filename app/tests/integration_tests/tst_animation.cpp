...
void AnimationIntegrationTest::addAnimation() {
  ...
  addAnimationToItem(item_number, start_time, duration);
...
void AnimationIntegrationTest::removeAnimation() {
  ...
  addAnimationToItem(item_number, 0.0, 1.0);
...
void AnimationIntegrationTest::addAnimationToItem(const qint32 item_number,
  ...
  auto item_context_menu =
      m_helper_functions->getChild<QObject*>("MVAItemContextMenu");
  auto item_context_menu_add_animation =
      m_helper_functions->getChild<QObject*>("MVAItemContextMenuAddAnimation");
  ...
  auto add_animation_dialog =
      m_helper_functions->getChild<QObject*>("MVAAnimationDialog");
  QVERIFY(QTest::qWaitFor(
...
void AnimationIntegrationTest::removeAnimationFromCurrentItem(
  ...
  auto animation_menu_delete =
      animation_item->findChild<QObject*>("MVAAnimationMenuDelete");
  QVERIFY(QTest::qWaitFor(
